...
+ Em seguida, utilizamos a função `beta_ordinal_simula_dados` para simular dados com base nos parâmetros personalizados fornecidos. A função recebe os seguintes argumentos:
