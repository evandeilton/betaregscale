...
# Equivalent to check_response — delta inferred from y
...
#>      left   right    yt  y delta         x1
#> 1 0.00001 0.05000 0.025 NA     1 -0.2827054
#> 2 0.20000 0.99999 0.600 NA     2 -0.5536994
#> 3 0.30000 0.45000 0.375 NA     3  0.6289820
#> 4 0.49500 0.50500 0.500 50     3  2.0650249
```
...
#> 1  (Intercept)  0.3392312 0.09872241  3.436212 5.899088e-04  0.14573878
#> 2           x1 -0.6445300 0.10939654 -5.891686 3.822756e-09 -0.85894331
#> 3           x2  0.3738654 0.10819762  3.455394 5.494893e-04  0.16180196
#> 4        (phi)  0.2049261 0.09322014  2.198303 2.792750e-02  0.02221803
#> 5  (Intercept)  0.2041063 0.06006633  3.398015 6.787663e-04  0.08637846
#> 6           x1 -0.3821542 0.06311114 -6.055258 1.401925e-09 -0.50584979
#> 7           x2  0.2235686 0.06498831  3.440136 5.814210e-04  0.09619390
#> 8        (phi)  0.2115155 0.09287685  2.277376 2.276375e-02  0.02948027
#> 9  (Intercept)  0.3339365 0.09607027  3.475961 5.090262e-04  0.14564224
#> 10          x1 -0.6714835 0.13361627 -5.025462 5.022216e-07 -0.93336655
#> 11          x2  0.3654699 0.10750561  3.399543 6.749860e-04  0.15476281
#> 12       (phi)  0.1830339 0.09397476  1.947693 5.145174e-02 -0.00115319
#> 13 (Intercept) -0.1693231 0.06616497 -2.559105 1.049421e-02 -0.29900407
#> 14          x1 -0.3757247 0.06296732 -5.966979 2.416865e-09 -0.49913833
#> 15          x2  0.2136847 0.06629000  3.223482 1.266421e-03  0.08375864
#> 16       (phi)  0.2323318 0.09199950  2.525359 1.155802e-02  0.05201605
#>       ci_upper    link
#> 1   0.53272352   logit
#> 2  -0.43011676   logit
#> 3   0.58592882   logit
...
#> 7   0.35094339  probit
#> 8   0.39355082  probit
#> 9   0.52223076 cauchit
#> 10 -0.40960042 cauchit
...
#> [2,] 0.073601086 0.40611615 0.8351903
#> [3,] 0.125179602 0.52371493 0.8976529
#> [4,] 0.220087706 0.67348688 0.9525970
#> [5,] 0.270331989 0.73257944 0.9680784
#> [6,] 0.143685163 0.55814195 0.9124645
```
...
#> x2           0.16180196  0.5859288
#> (phi)        0.02221803  0.3876342
...
#>        0.27958256       -0.44820458        0.19873549        0.08142918 
#>          (phi)_z1 
#>       -0.91701510
...
#>               (Intercept)            x1           x2
#> (Intercept)  7.526312e-03 -0.0010535138 9.147358e-06
#> x1          -1.053514e-03  0.0087243197 1.616653e-04
#> x2           9.147358e-06  0.0001616653 7.041609e-03
```
...
#> 2                 x1 -0.44820458 0.09340407 -4.7985553 1.598142e-06 -0.63127319
#> 3                 x2  0.19873549 0.08391430  2.3683150 1.786931e-02  0.03426649
#> 4  (phi)_(Intercept)  0.08142918 0.09412224  0.8651427 3.869605e-01 -0.10304703
#> 5           (phi)_z1 -0.91701510 0.10308437 -8.8957728 5.801416e-19 -1.11905674
...
#> 10          (phi)_z1 -0.91678541 0.10310939 -8.8913865 6.035108e-19 -1.11887610
#> 11       (Intercept)  0.24724531 0.07689481  3.2153707 1.302762e-03  0.09653426
#> 12                x1 -0.40391079 0.08959490 -4.5081894 6.538319e-06 -0.57951358
#> 13                x2  0.17683321 0.07462238  2.3697076 1.780216e-02  0.03057604
#> 14 (phi)_(Intercept)  0.07330179 0.09429400  0.7773750 4.369376e-01 -0.11151104
#> 15          (phi)_z1 -0.91651392 0.10304420 -8.8943767 5.874809e-19 -1.11847684
...
#> 20          (phi)_z1 -0.91498567 0.10292470 -8.8898551 6.118863e-19 -1.11671437
#>       ci_upper    link
#> 1   0.44961791   logit
#> 2  -0.26513598   logit
#> 3   0.36320449   logit
